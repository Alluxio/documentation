...
你可以在[这里](../operation/User-CLI.md)查看更多关于`validateEnv`命令的信息。
...
[Alluxio shell](../operation/User-CLI.md) 包含多种与 Alluxio 交互的命令行操作。如果要查看文件系统操作命令列表，运行：
...
Alluxio 通过统一命名空间的特性统一了对存储系统的访问。你可以阅读[统一命名空间的博客](https://www.alluxio.io/resources/whitepapers/unified-namespace-allowing-applications-to-access-data-anywhere/)和[统一命名空间文档](../core-services/Unified-Namespace.md)获取更详细的解释。
...
* [本地运行 Alluxio](../deploy/Running-Alluxio-Locally.md)
* [在集群上独立运行 Alluxio](../deploy/Running-Alluxio-on-a-Cluster.md)
* [在 Docker 上运行 Alluxio](../deploy/Running-Alluxio-On-Docker.md)

### 底层存储系统

有很多可以通过 Alluxio 访问的底层存储系统。

* [Alluxio 使用 Azure Blob Store](../ufs/Azure-Blob-Store.md)
* [Alluxio 使用 S3](../ufs/S3.md)
* [Alluxio 使用 GCS](../ufs/GCS.md)
* [Alluxio 使用 Minio](../ufs/Minio.md)
* [Alluxio 使用 CephFS](../ufs/CephFS.md)
* [Alluxio 使用 CephObjectStorage](../ufs/CephObjectStorage.md)
* [Alluxio 使用 Swift](../ufs/Swift.md)
* [Alluxio 使用 HDFS](../ufs/HDFS.md)
* [Alluxio 使用 OSS](../ufs/OSS.md)
* [Alluxio 使用 NFS](../ufs/NFS.md)

### 计算框架和应用

不同的计算框架和应用与 Alluxio 的集成。

* [Apache Spark 使用 Alluxio](../compute/Spark.md)
* [Apache Hadoop MapReduce 使用 Alluxio](../compute/Hadoop-MapReduce.md)
* [Apache Hive 使用 Alluxio](../compute/Hive.md)
* [Presto 使用 Alluxio](../compute/Presto.md)
