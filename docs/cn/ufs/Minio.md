...
可以
[从源代码编译Alluxio](../contributor/Building-Alluxio-From-Source.md)，
或[在本地下载二进制文件](../deploy/Running-Alluxio-Locally.md)。
...
存储桶名称的属性由[`alluxio.master.mount.table.root.ufs`](../reference/Properties-List.md#master配置项)控制。 
...
[`alluxio.underfs.s3.disable.dns.buckets`](../reference/Properties-List.md#共有配置项)
设置为`false`。
...
确保
[`alluxio.underfs.s3.endpoint`](../reference/Properties-List.md#共有配置项)
...
检查[`s3a.accessKeyId`](../reference/Properties-List.md#共有配置项)
和[`s3a.secretKey`](../reference/Properties-List.md#共有配置项)。
